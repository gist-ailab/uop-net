...
CSS_COLORS = ["black", "blue", "brown", "cyan", "darkblue",
    "darkcyan", "darkgray", "darkgreen", "darkmagenta",
    "darkred", "darkviolet", "gold", "gray", "green", "magenta",
    "maroon", "navy", "olive", "orange", "pink", "purple",
    "red", "silver", "violet", "white", "yellow", "aliceblue",
    "antiquewhite", "aquamarine", "azure", "beige", "bisque",
    "blanchedalmond", "blueviolet", "burlywood", "cadetblue",
